...
@objc public class PlayerView: UIView {
    ...
    public var fillMode: PlayerViewFillMode! {
        didSet {
            playerLayer.videoGravity = AVLayerVideoGravity(rawValue: fillMode.AVLayerVideoGravity)
        }
    }
    ...
    func addObserversVideoItem(playerItem: PVPlayerItem) {
        ...
        NotificationCenter.defaultCenter.addObserver(self, selector: .playerItemDidPlayToEndTime, name: AVPlayerItemDidPlayToEndTimeNotification, object: playerItem)
    }
    func removeObserversVideoItem(playerItem: PVPlayerItem) {
        ...
        NotificationCenter.defaultCenter.removeObserver(self, name: AVPlayerItemDidPlayToEndTimeNotification, object: playerItem)
    }
